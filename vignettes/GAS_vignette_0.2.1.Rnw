...
\begin{table}[H]
	...
	\begin{tabular}{ccccc}
        ...
        \code{ast1} (i) & $\Re^{~~}$ & $\Re^+$ & $\left(0.01,0.99\right)$ & $\left(2.01,50.0\right)$  \\
        \code{ald} & $\Re^{~~}$ & $\Re^+$ & $\Re^+$ & --  \\
		\code{poi} & $\Re^+$ & -- & -- & --  \\
		\code{gamma} & $\Re^+$ & $\Re^+$ & -- & --  \\
		\code{exp} & $\Re^+$ & -- & -- & --  \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section[Applications to financial returns]{Applications to financial returns}\label{sec:application}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
AA & $-1.95^b$ & $-2.33^a$ & $-2.13^b$ & $-1.99^b$ & $-2.14^b$ & $-1.02^{~}$ \\
AXP & $-2.83^a$ & $-2.20^b$ & $-3.00^a$ & $-1.10^{~}$ & $-1.47^c$ & $-1.47^c$ \\
BA & $-0.06^{~}$ & $-0.82^{~}$ & $-1.36^c$ & $-0.37^{~}$ & $-0.81^{~}$ & $-0.38^{~}$ \\
BAC & $-3.03^a$ & $-1.41^c$ & $-3.79^a$ & $ 0.10^{~}$ & $ 1.08^{~}$ & $-3.89^a$ \\
C & $-3.98^a$ & $-2.98^a$ & $-5.09^a$ & $-1.18^{~}$ & $-2.30^b$ & $-1.85^b$ \\
CAT & $-5.04^a$ & $-5.00^a$ & $-5.38^a$ & $-3.71^a$ & $-2.07^b$ & $-5.00^a$ \\
CVX & $ 0.56^{~}$ & $ 1.13^{~}$ & $-0.20^{~}$ & $ 1.31^c$ & $ 0.59^{~}$ & $ 0.96^{~}$ \\
DD & $-1.23^{~}$ & $-0.58^{~}$ & $-0.64^{~}$ & $-0.44^{~}$ & $ 0.37^{~}$ & $-1.09^{~}$ \\
DIS & $-2.18^b$ & $-1.77^b$ & $-2.40^a$ & $-1.10^{~}$ & $-1.70^b$ & $-0.93^{~}$ \\
GE & $-3.26^a$ & $-3.29^a$ & $-3.71^a$ & $-2.59^a$ & $-3.48^a$ & $-2.14^b$ \\
GM & $ 1.40^c$ & $ 0.21^{~}$ & $ 0.18^{~}$ & $ 0.18^{~}$ & $-0.60^{~}$ & $ 0.78^{~}$ \\
HD & $-3.42^a$ & $-2.55^a$ & $-1.86^b$ & $-2.74^a$ & $-1.45^c$ & $-1.94^b$ \\
HPQ & $-2.43^a$ & $-2.68^a$ & $-2.08^b$ & $-2.79^a$ & $-1.40^c$ & $-2.52^a$ \\
IBM & $-3.71^a$ & $-3.85^a$ & $-3.50^a$ & $-3.61^a$ & $-2.07^b$ & $-3.48^a$ \\
INTC & $-3.17^a$ & $-1.67^b$ & $-1.68^b$ & $-1.32^c$ & $-2.93^a$ & $ 0.13^{~}$ \\
JNJ & $-3.73^a$ & $-2.14^b$ & $-3.56^a$ & $-0.69^{~}$ & $-0.13^{~}$ & $-3.04^a$ \\
JPM & $-1.32^c$ & $-1.89^b$ & $-2.65^a$ & $-1.05^{~}$ & $-1.09^{~}$ & $-1.39^c$ \\
AIG & $ 0.00^{~}$ & $ 0.63^{~}$ & $-1.68^b$ & $ 0.71^{~}$ & $-0.85^{~}$ & $ 0.95^{~}$ \\
KO & $-3.04^a$ & $-2.93^a$ & $-3.66^a$ & $-1.41^c$ & $-3.22^a$ & $-1.57^c$ \\
MCD & $-1.88^b$ & $-1.76^b$ & $-2.05^b$ & $-1.33^c$ & $-1.58^c$ & $-1.04^{~}$ \\
MMM & $-4.07^a$ & $-4.46^a$ & $-4.07^a$ & $-4.05^a$ & $-3.28^a$ & $-3.32^a$ \\
MRK & $-2.98^a$ & $-3.62^a$ & $-4.15^a$ & $-3.07^a$ & $-4.56^a$ & $-1.92^b$ \\
MSFT & $-3.42^a$ & $-2.75^a$ & $-3.15^a$ & $-1.65^b$ & $-2.65^a$ & $-1.70^b$ \\
PFE & $-3.90^a$ & $-3.75^a$ & $-3.93^a$ & $-3.26^a$ & $-4.28^a$ & $-2.60^a$ \\
PG & $-1.70^b$ & $-1.78^b$ & $-2.81^a$ & $-1.20^{~}$ & $-1.29^c$ & $-1.26^{~}$ \\
T & $-0.38^{~}$ & $-0.22^{~}$ & $-1.21^{~}$ & $ 0.29^{~}$ & $ 0.36^{~}$ & $-0.63^{~}$ \\
UTX & $-1.50^c$ & $-1.61^c$ & $-1.74^b$ & $-1.38^c$ & $-1.11^{~}$ & $-0.89^{~}$ \\
VZ & $-2.02^b$ & $-1.99^b$ & $-1.52^c$ & $-2.01^b$ & $-1.39^c$ & $-1.55^c$ \\
WMT & $ 0.61^{~}$ & $-0.25^{~}$ & $-0.50^{~}$ & $ 0.03^{~}$ & $-1.61^c$ & $ 1.12^{~}$ \\
XOM & $ 0.16^{~}$ & $ 0.38^{~}$ & $-1.27^{~}$ & $ 0.72^{~}$ & $ 0.69^{~}$ & $-0.04^{~}$ \\
		\bottomrule
	\end{tabular}
	%}
...
The results in this paper were obtained using \proglang{R} 3.4.0 \citep{R} with the
packages: \pkg{GAS} version 0.2.1 \citep{GAS}, \pkg{lmtest} version 0.9-35 \citep{lmtest},  \pkg{MASS} version 7.3-47 \citep{MASS.2002,MASS}, \pkg{numDeriv} version 2016.8-1 \citep{numDeriv},
\pkg{Rcpp} version 0.12.11 \citep{Rcpp.2011,Rcpp}, \pkg{RcppArmadillo} version 0.7.800.2.0 \citep{RcppArmadillo.2014,RcppArmadillo}, \pkg{rugarch} version 1.3-6 \citep{rugarch}, \pkg{sandwich} version 2.3-4 \citep{zeileis.2004}, \pkg{xts} version 0.9-7 \citep{xts}, and \pkg{zoo} version 1.8-0 \citep{zoo}. Some datasets available in the package were downloaded using the \pkg{quantmod} package \citep{quantmod}, version 0.4-8. Computations were performed on Windows 10 Pro, x86\_64-w64-mingw32/x64 (64-bit) with Intel(R) Xeon(R) CPUE3-1535M v6 Max Turbo Frequency \@4.20 GHz. Full output of the computations is available in the file \code{sink\_PART\_II\_R3.4.0\_mingw32.txt} in the folder \code{inst/doc}.
...
We also thank Alexios Ghalanos for his help regarding the platform dependence of \pkg{Rsolnp} and \pkg{rugarch} packages.
...
\newblock \emph{\pkg{Rcpp}: {S}eamless \proglang{R} and \proglang{C++}
  Integration}.
\newblock \proglang{R}~package version 0.12.11,
...
\newblock \proglang{R}~package version 0.7.800.2.0,
...
\newblock \proglang{R}~version 3.4.0,
...
\newblock \proglang{R}~package version 0.4-8,
